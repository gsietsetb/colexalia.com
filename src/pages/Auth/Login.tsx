...
const Login = () => {
  ...
  // Si hay un estado de redirección, lo usamos, si no, redirigimos al dashboard
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
              className="flex justify-center items-center w-full border border-gray-300 rounded-md px-4 py-2 bg-white text-gray-700 hover:bg-gray-50"
            >
